    ...
    public class ConnectionProvider(IConfiguration configuration, AESSecurity_BLL security) : IConnectionProvider
    {
        ...
        public IDbConnection CreateConnection(string connectiontype)
        {
            ...
            case ConnectionStringConfig.FeeDB:
                ...
                break;
            case ConnectionStringConfig.SHRIDB:
                DecryptString = _configuration.GetSection("ConnectionStrings").GetSection("SHRIDB").Value;
                break;
            case ConnectionStringConfig.SCDB:
                DecryptString = _configuration.GetSection("ConnectionStrings").GetSection("SCDB").Value;
                break;
            default:
